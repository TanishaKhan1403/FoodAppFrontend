...
export class BranchService {
  ...
  deleteData(id:any){
   return this.http.delete(`http://localhost:8080/api/deletebranch/${id}`);
  }
  
  //updating http method
  updateData(id:any,branch:any){
      return this.http.put(`http://localhost:8080/api/updatebranch/${id}`,branch);
  }
